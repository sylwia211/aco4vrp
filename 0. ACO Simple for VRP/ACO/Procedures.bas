...
ReDim BaCapUsed(1 To MaxNv) As Double
ReDim BaCovered(1 To MaxNv) As Double
ReDim Best_Solution(0 To 2, 0 To Nodes + MaxNv + 1)
ReDim Solution(0 To Generations, 0 To Nodes + MaxNv + 1)
...
ReDim CapUsed(1 To MaxNv)
ReDim Covered_Distance(1 To MaxNv)
ReDim Preserve Objective_Function(1 To Ants)
ReDim Route(0 To Nodes + MaxNv)
